  ...
  return (
    <form action={action} className="admin-form admin-story-form" onChange={() => setDirty(true)}>
      ...
      <div className="admin-story-form-grid">
        ...
        <div className="admin-field admin-field-wide"><label htmlFor="street_address">Street address</label><input aria-describedby={described("street_address")} aria-invalid={Boolean(state.fieldErrors.street_address)} defaultValue={place?.street_address ?? ""} id="street_address" maxLength={500} name="street_address" /><FieldError id="street_address-error" message={state.fieldErrors.street_address} /></div>
        <div className="admin-field"><label htmlFor="postal_code">Postal code</label><input aria-describedby={described("postal_code")} aria-invalid={Boolean(state.fieldErrors.postal_code)} defaultValue={place?.postal_code ?? ""} id="postal_code" maxLength={40} name="postal_code" /><FieldError id="postal_code-error" message={state.fieldErrors.postal_code} /></div>
